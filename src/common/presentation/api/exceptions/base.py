...
from rest_framework.exceptions import APIException  # noqa: WPS450
...
class APIUnauthorized(APIBaseException):
...
class APINotImplemented(APIBaseException):
    ...
    default_detail = _('Tenant not implemented.')
    default_code = 'tenant_not_implemented'
...
class BaseModelSerializer(SerializerFieldExceptionMixin, serializers.ModelSerializer):
    pass
